...
def generar_reporte(database):
    ...
    for fila in database:
        ...
        if tipo_especialidad not in especialidades_por_tipo:
            especialidades_por_tipo[tipo_especialidad] = set()
        especialidades_por_tipo[tipo_especialidad].add(especialidad)

    for tipo, especialidades in especialidades_por_tipo.items():
        cantidad_especialidades = len(especialidades)
        linea = f"Cantidad Especialidades de {tipo}: {cantidad_especialidades}"
